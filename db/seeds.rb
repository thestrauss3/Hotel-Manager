...
cancelled_current = Booking.create(customer: diane, room: r102, scheduled_checkin: (midnight - 2.days + 16.hours), scheduled_checkout: (midnight + 11.hours), status: 'Cancelled', actual_checkin: (midnight - 2.days + 19.hours))

cancelled_past = Booking.create(customer: jack, room: r202, scheduled_checkin: (midnight - 4.days + 16.hours), scheduled_checkout: (midnight - 2.days + 11.hours), status: 'Cancelled')

cancelled_future = Booking.create(customer: bob, room: penthouse, scheduled_checkin: (midnight + 1.day + 16.hours), scheduled_checkout: (midnight + 4.days + 11.hours), status: 'Cancelled')
